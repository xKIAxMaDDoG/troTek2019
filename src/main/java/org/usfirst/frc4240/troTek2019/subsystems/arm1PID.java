...
public class arm1PID extends PIDSubsystem {
    ...
    public arm1PID() {
        ...
        super("arm1PID", 0.8, 0.0, 0.0);
        setAbsoluteTolerance(0.9);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        ...
        armQuad1.setDistancePerPulse(0.01);
        armQuad1.setPIDSourceType(PIDSourceType.kDisplacement);
        

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        armTalon1.setInverted(true);
        armTalon2.setInverted(true);

        armTalon1.configOpenloopRamp(.0625);
        armTalon2.configOpenloopRamp(.0625);
